...
using AnimeKingdomAPI.Application.TodoItems.Commands.CreateTodoItem;
using AnimeKingdomAPI.Application.TodoItems.Commands.DeleteTodoItem;
using AnimeKingdomAPI.Application.TodoItems.Commands.UpdateTodoItem;
using AnimeKingdomAPI.Application.TodoItems.Commands.UpdateTodoItemDetail;
using AnimeKingdomAPI.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace AnimeKingdomAPI.Web.Endpoints;

using AnimeKingdomAPI.Application.Common.Exceptions;
using AnimeKingdomAPI.Application.Common.Security;
using AnimeKingdomAPI.Application.TodoLists.Commands.CreateTodoList;
using AnimeKingdomAPI.Application.TodoLists.Commands.PurgeTodoLists;
using AnimeKingdomAPI.Domain.Entities;

namespace AnimeKingdomAPI.Application.FunctionalTests.TodoLists.Commands;
